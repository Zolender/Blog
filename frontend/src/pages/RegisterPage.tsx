        ...
        <div className="max-w-md mx-auto mt-16">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                    ...
                    <input type="text" id="username" required value={username} onChange={(e)=> setUsername(e.target.value)} className="border border-gray-300 rounded-sm placeholder-zinc-300 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
