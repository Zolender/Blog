    ...
    return (
        <div className="min-h-screen bg-surface flex flex-col items-center justify-center px-4 py-12">
            ...
            >
                ...
                <p className="meta-text uppercase tracking-widest">The Quiet Room</p>
            </motion.div>
            ...
            >
                ...
                {error && (
                    <div role="alert" aria-live="polite" className="error-banner mb-5">{error}</div>
                )}
                    ...
                    >
                        {!isLogin && (
                            <FloatingInput
                                ...
                                value={fields.username} onChange={setField("username")}
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            {isLogin && (
                                <div className="flex justify-end">
                                    <Link
                                        to="/forgot-password"
                                        className="font-sans text-xs text-muted hover:text-accent transition-colors"
                                    >
                                        Forgot password?
                                    </Link>
                                </div>
